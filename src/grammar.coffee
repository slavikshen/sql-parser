...
grammar =
	...
	SelectClause: [
		o 'SELECT Fields FROM Table',												 -> new Select( null, $2, $4, false)
		o 'SELECT DISTINCT Fields FROM Table',								-> new Select( null, $3, $5, true)
		o 'SELECT Fields FROM Table Joins',									 -> new Select( null, $2, $4, false, $5)
		o 'SELECT DISTINCT Fields FROM Table Joins',					-> new Select( null, $3, $5, true, $6)
		o 'SELECT Top Fields FROM Table',												 -> new Select($2, $3, $5, false)
		o 'SELECT Top Fields FROM Table',												 -> new Select( null, $3, $5, false)
		o 'SELECT Top DISTINCT Fields FROM Table',								-> new Select( null, $4, $6, true)
		o 'SELECT Top Fields FROM Table Joins',									 -> new Select( null, $3, $5, false, $6)
		o 'SELECT Top DISTINCT Fields FROM Table Joins',					-> new Select( null, $4, $6, true, $7)
	...
	LimitClause: [
		...
		o 'SAMPLE Number',																		-> new Sample($2)
	]

	Top: [
		o 'TOP Number',																		-> new Top($2)
	]
